    ...
    <div class="card">
      ...
      <div class="card-header">
        <div class="row">
          ...
          <div>
            <a href="{{ route('jabatans.create') }}" class="btn btn-primary mb-2">Create</a>
          </div>
        </div>
      </div>
      <div class="card-body">
        <table class="table">
          ...
          <tbody>
            ...
            <tr>
              <td scope="row">{{ $jabatan->id }}</td>
                <td>{{ $jabatan->name_jabatan }}</td>
                <td>
                  <a href="{{ route('jabatans.edit', $jabatan->id) }}" class="btn btn-success">Edit</a>
                </td>
            </tr>
            @empty
            <tr>
